...
<div class="slider-container" style="width: 100%; height: 40vh; overflow: hidden; position: relative;">
    <div class="slider" style="display: flex; width: 300%; transition: transform 0.5s ease-in-out;">
        <!-- <div class="slide" style="flex: 0 0 33.33%;">
            <img src="assets\images\banner-image-5.png" alt="Slide 1" style="width: 100%; height: 49%;">
        </div> -->
        <div class="slide" style="flex: 0 0 33.33%;">
            <img src="assets\images\banner-image-4.png" alt="Slide 2" style="width: 100%; height: 55%;">
        </div>
        <div class="slide" style="flex: 0 0 33.33%;">
            <img src="assets\images\MS-BG.png" alt="Slide 3" style="width: 100%; height: 55%;">
        </div>
        <div class="slide" style="flex: 0 0 33.33%;">
            <img src="assets\images\banner-image-old2.jpg" alt="Slide 4" style="width: 100%; height: 40vh;">
        </div>
    </div>
</div>
