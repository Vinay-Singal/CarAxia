...
if (isset ($_POST['submit'])) {
  ...
  $ret = "SELECT *, paymod FROM tblbooking 
  ...
  $query1->bindParam(':paymod', $paymod, PDO::PARAM_STR);
  $query1->execute();
  $results1 = $query1->fetchAll(PDO::FETCH_OBJ);

  if ($query1->rowCount() == 0) {

    $sql = "INSERT INTO  tblbooking(BookingNumber,userEmail,VehicleId,FromDate,ToDate,paymod,message,Status) VALUES(:bookingno,:useremail,:vhid,:fromdate,:todate,:paymod,:message,:status)";
    ...
    $query->bindParam(':paymod', $paymod, PDO::PARAM_STR);
          ...
          <div class="sidebar_widget">
            ...
            <form method="post">
              ...
              <div class="payment-mode">
                ...
                <input type="radio" id="upi" name="paymod" value="upi" required onclick="showUpiFields()">
                <label for="cards">Credit/Debit Cards</label>
                <input type="radio" id="cards" name="paymod" value="cards" required onclick="showCardFields()">
                <div class="form-group" id="upiFields" style="display: none;">
                  <label>Enter UPI ID:</label>
                  <input type="text" class="form-control" name="upiId" placeholder="Your UPI ID" required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="cardHolder" placeholder="Card Holder Name" required>
                </div>
                <div class="form-group">
