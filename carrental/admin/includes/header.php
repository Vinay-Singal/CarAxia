<div class="brand clearfix">
    <a class="navbar-brand" href="dashboard.php" style="color: white; font-family: 'Sofia', sans-serif; position: relative;">
        ...
        <svg viewBox="0 0 100 10" preserveAspectRatio="none" style="position: absolute; bottom: -1px; left: 0; width: 100%;">
    ...
    <ul class="ts-profile-nav">
        <li class="ts-account">
            ...
            <ul>
                <li><a href="change-password.php">Change the Password</a></li>
